...
public class RedisUtil {
     ...
     */
    public boolean hashAdd(String key, Map<String, Object> map) {
        try {
     ...
     * @return true成功 false失败
     */
    public boolean hashAdd(String key, Map<String, Object> map, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            if (time > 0) {
                expire(key, time);
     ...
     */
    public boolean hashAdd(String key, String item, Object value) {
        try {
     ...
     * @return true 成功 false失败
     */
    public boolean hashAdd(String key, String item, Object value, long time) {
        try {
            redisTemplate.opsForHash().put(key, item, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return 成功个数
     */
    public long addSet(String key, long time, Object... values) {
        try {
